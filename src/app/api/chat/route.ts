...
- Contact : formulaire de demande de service sur la page Contact,
  ou email abidjandigitalia@gmail.com.
...
- Ne donne JAMAIS de prix, de tarifs, de délais ou de devis précis : tu ne les
  ...
  le formulaire de demande de service ou à écrire à abidjandigitalia@gmail.com.
...
export async function POST(req: NextRequest) {
  ...
  if (!apiKey) {
    return NextResponse.json(
      {
        reply:
          "Le chatbot est temporairement indisponible. Pour toute question, écrivez-nous à abidjandigitalia@gmail.com.",
      },
      { status: 200 }
    );
  }
